    ...
    return (
        <div className="page-container">
            ...
            <div className="mb-4 sm:mb-6">
                <div className="flex items-center justify-start sm:justify-center gap-1 rounded-xl border border-black/10 bg-white p-1 dark:border-white/10 dark:bg-white/5 overflow-x-auto scrollbar-hide">
