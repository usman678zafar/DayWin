        ...
        <div className="min-h-screen bg-white text-black">
            <div className="mx-auto grid min-h-screen max-w-6xl items-center gap-10 px-4 py-10 md:grid-cols-2 md:px-8">
                ...
                <section className="rounded-2xl border border-black/15 bg-white p-6 shadow-sm sm:p-8">
                    ...
                    <Suspense fallback={<div className="mt-6 flex h-40 items-center justify-center"><div className="h-8 w-8 animate-spin rounded-full border-2 border-black border-t-transparent" /></div>}>
                        <LoginForm />
                    </Suspense>
                </section>
            </div>
