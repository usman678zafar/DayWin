...
export function Navbar() {
    ...
    return (
        <>
            <aside className="hidden md:flex fixed left-0 top-0 bottom-0 w-72 flex-col border-r border-surface-200/50 bg-white/80 px-5 py-6 backdrop-blur-xl dark:border-white/[0.05] dark:bg-[#0A0A0F]/80 z-40 transition-all duration-300">
                <Link href="/" className="mb-10 px-3 flex items-center gap-3 group">
                    <DailyWinLogo
                        label="DAY WIN"
                        iconClassName="h-10 w-10 rounded-xl shadow-lg shadow-primary-500/20 group-hover:scale-105 transition-transform duration-300"
                        textClassName="text-sm font-black tracking-[0.2em] text-foreground transition-colors"
                    />
                </Link>
                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            <Link
                                ...
                                href={item.href}
                                className={cn(
                                    "relative flex items-center gap-3.5 rounded-xl px-5 py-3.5 text-sm font-bold transition-all duration-300 group overflow-hidden",
                                    isActive
                    ...
                    <div className="relative overflow-hidden rounded-2xl border border-surface-200/50 bg-gradient-to-b from-white to-surface-50/50 p-4 dark:border-white/[0.05] dark:from-white/[0.03] dark:to-transparent backdrop-blur-sm transition-all duration-300 hover:border-primary-500/30 hover:shadow-lg hover:shadow-primary-500/5 group cursor-default">
                        <div className="flex items-center gap-3.5">
                            ...
                            <div className="min-w-0 flex-1">
                                <p className="truncate text-sm font-bold text-surface-900 dark:text-surface-100 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors duration-300">
